...
public class Leaves {
	...
	public Leaves(int id,int ltid, String reason, Date fromDate, Date toDate, int duration,
			boolean acceptRejectFlag, int taken, boolean active, String uid) {
		super();
		this.id = id;
		this.type = new Leaves_Types(ltid);
		this.reason = reason;
